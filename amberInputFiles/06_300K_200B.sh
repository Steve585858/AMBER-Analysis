...
#PBS -N 06_300K_200B                  ## Set job name
#PBS -o logs/06_300K_200B.log     ## Write standard output file name
#PBS -e logs/06_300K_200B.error   ## Write standard output file name

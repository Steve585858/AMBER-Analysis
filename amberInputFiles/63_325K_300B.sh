...
#PBS -N 63_325K_300B                  ## Set job name
#PBS -o logs/63_325K_300B.log     ## Write standard output file name
#PBS -e logs/63_325K_300B.error   ## Write standard output file name

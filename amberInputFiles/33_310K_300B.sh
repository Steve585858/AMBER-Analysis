...
#PBS -N 33_310K_300B                  ## Set job name
#PBS -o logs/33_310K_300B.log     ## Write standard output file name
#PBS -e logs/33_310K_300B.error   ## Write standard output file name

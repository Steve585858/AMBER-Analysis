...
#PBS -N 56_320K_300B                  ## Set job name
#PBS -o logs/56_320K_300B.log     ## Write standard output file name
#PBS -e logs/56_320K_300B.error   ## Write standard output file name

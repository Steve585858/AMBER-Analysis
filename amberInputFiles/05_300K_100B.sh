...
#PBS -N 05_300K_100B                  ## Set job name
#PBS -o logs/05_300K_100B.log     ## Write standard output file name
#PBS -e logs/05_300K_100B.error   ## Write standard output file name

...
#PBS -N 13_315K_300B                  ## Set job name
#PBS -o logs/13_315K_300B.log     ## Write standard output file name
#PBS -e logs/13_315K_300B.error   ## Write standard output file name

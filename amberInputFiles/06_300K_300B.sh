...
#PBS -N 06_300K_300B                  ## Set job name
#PBS -o logs/06_300K_300B.log     ## Write standard output file name
#PBS -e logs/06_300K_300B.error   ## Write standard output file name

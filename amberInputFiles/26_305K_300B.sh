...
#PBS -N 26_305K_300B                  ## Set job name
#PBS -o logs/26_305K_300B.log     ## Write standard output file name
#PBS -e logs/26_305K_300B.error   ## Write standard output file name

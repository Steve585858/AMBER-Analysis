...
#PBS -N 05_300K_200B                  ## Set job name
#PBS -o logs/05_300K_200B.log     ## Write standard output file name
#PBS -e logs/05_300K_200B.error   ## Write standard output file name

...
#PBS -N 04_300K_Pressure                  ## Set job name
#PBS -o logs/04_300K_Pressure.log     ## Write standard output file name
#PBS -e logs/04_300K_Pressure.error   ## Write standard output file name
...
base="04_300K"
##NAMES=("010B" "025B" "050B" "100B")
NAMES=("050B" "075B" "100B" "125B" "150B" "175B" "200B" "225B" "250B" "275B" "300B" )
##NAMES=("01")
##prevName="03_Heat_01"
prevName="04_300K_025B"

for name in ${NAMES[@]}; do
   currName=${base}_${name}
   echo starting mpirun on $currName
   mpirun -np 2 pmemd.cuda.MPI -O \
      -i ${currName}.in -o ${currName}.out -p $prmtop -c ${prevName}.rst \

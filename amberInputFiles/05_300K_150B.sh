...
#PBS -N 05_300K_150B                  ## Set job name
#PBS -o logs/05_300K_150B.log     ## Write standard output file name
#PBS -e logs/05_300K_150B.error   ## Write standard output file name

...
#PBS -N 05_300K_010B                  ## Set job name
#PBS -o logs/05_300K_010B.log     ## Write standard output file name
#PBS -e logs/05_300K_010B.error   ## Write standard output file name

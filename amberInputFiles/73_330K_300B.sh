...
#PBS -N 73_330K_300B                  ## Set job name
#PBS -o logs/73_330K_300B.log     ## Write standard output file name
#PBS -e logs/73_330K_300B.error   ## Write standard output file name

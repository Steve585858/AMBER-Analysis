...
#PBS -N 06_300K_150B                  ## Set job name
#PBS -o logs/06_300K_150B.log     ## Write standard output file name
#PBS -e logs/06_300K_150B.error   ## Write standard output file name

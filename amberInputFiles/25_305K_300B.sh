...
#PBS -N 25_305K_300B                  ## Set job name
#PBS -o logs/25_305K_300B.log     ## Write standard output file name
#PBS -e logs/25_305K_300B.error   ## Write standard output file name
